...
checkpoint = torch.load('./pretained_weights/kitti_15_BGNet_Plus.pth', map_location=lambda storage, loc: storage)
model.load_state_dict(checkpoint)
model.eval()
left_img = Image.open('/home/wangqingyu/桌面/recr4.png').convert('L')
right_img = Image.open('/home/wangqingyu/桌面/recl4.png').convert('L')
w, h = left_img.size
h1 = h % 64
w1 = w % 64
h1 = h - h1
